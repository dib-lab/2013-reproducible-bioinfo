...
Windows and Unix system (Linux and Mac OSX) systems. In the United States, most people
...
tools they need for free.  Further, Unix systems are commonly used when 
...
Wikipedia and other resources to find tutorials, examples, and other informations.
\texttt{software-carpentry.org} website is a good place to start with for a tutorial
for many Unix commands.
...
Both editors are cross-platform and have features that help increase the productivity
such as macros that can record and perform a task repeatedly, a regular expression
for search/replace and etc.
Emacs and Vi can also be programmed to function in a particular way with
...
A programming langauge is a set of instructions that can be translated into
a machine code that instructs a computer to perform a task.
